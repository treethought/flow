...
func RegisterExecutionAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ExecutionAPIServer) error {
	...
	mux.Handle("POST", pattern_ExecutionAPI_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/execution.ExecutionAPI/Ping", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/Ping"))
		if err != nil {
	...
	mux.Handle("POST", pattern_ExecutionAPI_GetAccountAtBlockID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/execution.ExecutionAPI/GetAccountAtBlockID", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/GetAccountAtBlockID"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ExecutionAPI_ExecuteScriptAtBlockID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/execution.ExecutionAPI/ExecuteScriptAtBlockID", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/ExecuteScriptAtBlockID"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ExecutionAPI_GetEventsForBlockIDs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/execution.ExecutionAPI/GetEventsForBlockIDs", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/GetEventsForBlockIDs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ExecutionAPI_GetTransactionResult_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/execution.ExecutionAPI/GetTransactionResult", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/GetTransactionResult"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterExecutionAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ExecutionAPIClient) error {
	...
	mux.Handle("POST", pattern_ExecutionAPI_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/execution.ExecutionAPI/Ping", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/Ping"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ExecutionAPI_GetAccountAtBlockID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/execution.ExecutionAPI/GetAccountAtBlockID", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/GetAccountAtBlockID"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ExecutionAPI_ExecuteScriptAtBlockID_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/execution.ExecutionAPI/ExecuteScriptAtBlockID", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/ExecuteScriptAtBlockID"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ExecutionAPI_GetEventsForBlockIDs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/execution.ExecutionAPI/GetEventsForBlockIDs", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/GetEventsForBlockIDs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ExecutionAPI_GetTransactionResult_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/execution.ExecutionAPI/GetTransactionResult", runtime.WithHTTPPathPattern("/execution.ExecutionAPI/GetTransactionResult"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ExecutionAPI_Ping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"execution.ExecutionAPI", "Ping"}, ""))

	pattern_ExecutionAPI_GetAccountAtBlockID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"execution.ExecutionAPI", "GetAccountAtBlockID"}, ""))

	pattern_ExecutionAPI_ExecuteScriptAtBlockID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"execution.ExecutionAPI", "ExecuteScriptAtBlockID"}, ""))

	pattern_ExecutionAPI_GetEventsForBlockIDs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"execution.ExecutionAPI", "GetEventsForBlockIDs"}, ""))

	pattern_ExecutionAPI_GetTransactionResult_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"execution.ExecutionAPI", "GetTransactionResult"}, ""))
)
